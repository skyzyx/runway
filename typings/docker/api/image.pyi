...
class ImageApiMixin:
    @utils.check_resource("image")  # type: ignore[untyped-decorator]
    ...
    @utils.minimum_version("1.30")  # type: ignore[untyped-decorator]
    @utils.check_resource("image")  # type: ignore[untyped-decorator]
    ...
    @utils.minimum_version("1.25")  # type: ignore[untyped-decorator]
