...
class ImageApiMixin:
    ...
    @utils.check_resource("image")
    def inspect_distribution(self, image: str, auth_config: dict[str, Any] | None = ...) -> dict[str, Any]: ...
    ...
    @utils.check_resource("image")
    def remove_image(self, image: str, force: bool = ..., noprune: bool = ...) -> dict[str, Any]: ...
    def search(self, term: str, limit: int | None = ...) -> list[dict[str, Any]]: ...
    @utils.check_resource("image")
    def tag(self, image: str, repository: str | None, tag: str = ..., force: bool = ...) -> bool: ...
