...
class ReadFileChunk:
    ...
    @classmethod
    def from_filename(cls, filename, start_byte, chunk_size, callback=..., enable_callback=...): ...
...
class ShutdownQueue(queue.Queue):  # type: ignore[misc]
    def trigger_shutdown(self): ...
    def put(self, item): ...

class MultipartDownloader:
    def __init__(self, client, config, osutil, executor_cls=...) -> None: ...
    def download_file(self, bucket, key, filename, object_size, extra_args, callback=...): ...
