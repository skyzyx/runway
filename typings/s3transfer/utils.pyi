...
def get_callbacks(transfer_future: TransferFuture, callback_type: str) -> list[Callable[..., Any]]: ...
def invoke_progress_callbacks(callbacks: list[Callable[..., Any]], bytes_transferred: int) -> None: ...
...
class OSUtils:
    ...
    def rename_file(self, current_filename: _AnyPath, new_filename: _AnyPath) -> None: ...
    @classmethod
...
class DeferredOpenFile:
    def __init__(self, filename, start_byte=..., mode=..., open_function=...) -> None: ...
    @property
    def name(self): ...
...
class ReadFileChunk:
    ...
    @classmethod
    def from_filename(cls, filename, start_byte, chunk_size, callbacks=..., enable_callbacks=...): ...
    def read(self, amount=...): ...
