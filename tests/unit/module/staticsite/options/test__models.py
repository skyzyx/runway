...
class TestRunwayStaticSiteExtraFileDataModel:
    ...
    def test_init_content(self) -> None:
        ...
        obj = RunwayStaticSiteExtraFileDataModel.model_validate(data)
...
class TestRunwayStaticSiteSourceHashingDataModel:
    ...
    def test_init_extra(self) -> None:
        """Test init extra."""
        with pytest.raises(ValidationError):
            RunwayStaticSiteSourceHashingDataModel.model_validate({"invalid": "test"})
...
class TestRunwayStaticSiteSourceHashingDirectoryDataModel:
    ...
    def test_init(self, tmp_path: Path) -> None:
        ...
        obj = RunwayStaticSiteSourceHashingDirectoryDataModel.model_validate(data)
